...
class HybridJDParser:
    ...
    def parse(self, raw_text: str, job_title: Optional[str] = None) -> CanonicalJD:
        ...
        for section_name, section_text in sections.items():
            ...
            # Use LLM to extract granular requirements from the section text
            extracted_items = self.llm_extractor.extract_requirements(section_text, section_name)
            ...
            for item in extracted_items:
                ...
                # The LLM's claimed source_span MUST exist exactly in the provided text.
                if source_span not in section_text:
                    # Log hallucination / rejection
                ...
                req = Requirement(
                    ...
                    confidence=0.9, # High because it passed strict validation
